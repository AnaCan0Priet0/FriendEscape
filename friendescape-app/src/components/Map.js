    ...
    return (
        <Map center={[40.429965, -3.697407]} zoom={5}>
            ...
            <Marker position={positionOuija}>
                ...
                <a href="http://www.horrorbox.es/producto/ouija-escape-room/">Web</a>   </Popup>
            </Marker>
            <Marker position={positionParanormal}>
                <Popup>Paranormal experience<br/>
                <a href="https://www.madridterror.com">Web</a>   </Popup>
            </Marker>
            <Marker position={positionInframundo}>
                <Popup>Inframundo<br/>
                <a href="https://amazein60.com/">Web</a>   </Popup>
            </Marker>
            <Marker position={positionGhost}>
                <Popup>Ghost adventure<br/>
                <a href="https://guaridaventuras.com/">Web</a>   </Popup>
            </Marker>
            <Marker position={positionSummer}>
                <Popup>Horror Summer<br/>
                <a href="https://www.kaosescapes.com/booking">Web</a>   </Popup>
            </Marker>
            <Marker position={positionLegado}>
                <Popup>El legado de Laozi<br/>
                <a href="http://www.fluxusgames.com/services/laozi/">Web</a>   </Popup>
            </Marker>
            <Marker position={positionCastillo}>
                <Popup> Castillo Sant Angelo<br/>
                <a href="https://komnataquest.es/barcelona/escape-room-quest-sanangeloit/">Web</a>   </Popup>
            </Marker>
            <Marker position={positionBlas}>
                <Popup> Blas de Lezo<br/>
                <a href="https://www.vientoenpopaescape.es/">Web</a>   </Popup>
            </Marker>
            <Marker position={positionChernobyl}>
                <Popup> Chernobyl<br/>
                <a href="https://tiempolimitecordoba.com/sala-2/">Web</a>   </Popup>
            </Marker>
            <Marker position={positionVacuna}>
                <Popup> La vacuna del Dr. Painokovic<br/>
                <a href="https://www.escaperoomarcadia.com/reservar/">Web</a>   </Popup>
            </Marker>
            <Marker position={positionBosco}>
                <Popup> Las profecías de El Bosco<br/>
                <a href="http://totemescaperoom.com/es/reservas/">Web</a>   </Popup>
            </Marker>
            <Marker position={positionSecreto}>
                <Popup> El secreto de la montaña<br/>
                <a href="https://www.hauntedhouse.es/escapes/el-secreto-de-la-montana/">Web</a>   </Popup>
            </Marker>
            <Marker position={positionTrono}>
                <Popup> El Trono de Hierro <br/>
                <a href="https://komnataquest.es/elche/244/timetable/">Web</a>   </Popup>
            </Marker>
            <Marker position={positionAsalto}>
                <Popup> El Trono de Hierro <br/>
                <a href="https://elcuboescaperoom.com/">Web</a>   </Popup>
            </Marker>
            ...
            <Marker position={positionAsesino}>
                ...
                <a href="http://www.horalimite-escaperoom.es/">Web</a>   </Popup>
            </Marker>
            <Marker position={positionPadrino}>
                <Popup> El Padrino <br/>
                <a href="https://thekeyvalladolid.com/padrino-mafiosos/">Web</a>   </Popup>
            </Marker>
            <Marker position={positionBlanca}>
                <Popup> Experiencia Blanca <br/>
                <a href="https://experiencitymadrid.com/experiencia-blanca/">Web</a>   </Popup>
            </Marker>
            <Marker position={positionFuturo}>
                <Popup> Steampunk, el futuro Tempo <br/>
                <a href="https://www.escaperoomlover.com/es/juego/tempo-0-sevilla-steampunk-el-futuro">Web</a>   </Popup>
            </Marker>
